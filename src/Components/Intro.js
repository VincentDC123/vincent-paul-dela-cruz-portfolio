    ...
    <div className="h-screen w-full bg-gray-300 fixed">
      <div className="h-full w-full overflow-y-scroll no-scrollbar">
        <div className="px-5 py-5 flex items-start justify-between">
          ...
          <div className="px-2 text-2xl font-medium">
            Software Engineer
          </div>
        </div>
        <div className="px-5 py-5 flex items-stretch ">
          <p className="px-5 py-5 border-double border-4 border-zinc-950">
            ...
            My backstory is that I was born in the Philippines and moved to California at the age of 7. 
            I was introduced to gaming and at the age of 11, I got into a game called Minecraft. 
            Minecraft was my gateway to coding which is one of the reasons why I went into computer science. 
            After doing 2 years of community college, I transferred to California State University Long Beach where I got my bachelor’s degree in computer science.
            During that time, I did a semester abroad in South Korea which broadened my perspective on how different cultures influence learning styles. 
            While studying, I found that Java was my favorite language which reflects on my projects. 
          ...
          <div className="px-5 py-5 border-double border-4 border-zinc-950">
            ...
            <a className="">
            Enthusiastic computer science graduate seeking a full-time position in your company where I can contribute to team
            success through hard work, diligence, and excellent organizational skills. Clear understanding Java. Motivated to
            learn, grow, and excel in software development.
            </a>
          </div>
        </div>
        <div className="px-5 py-3">
          <div className="px-5 py-5 border-double border-4 border-zinc-950 overflow-scroll">
            <div className="py-4 flex font-bold text-lg items-center justify-center">
              Technical Skills
            </div>
            <a className="flex items-center justify-normal">
